...
module WorldCat
  module Discovery
    ...
    DCTERMS_IS_PART_OF     = RDF::URI.new('http://purl.org/dc/terms/isPartOf')
    ...
    DISCOVERY_TOTAL_RESULTS2 = RDF::URI.new('http://worldcat.org/vocab/discovery/totalResults')
    DISCOVERY_ITEMS_PER_PAGE = RDF::URI.new('http://worldcat.org/searcho/itemsPerPage')
    DISCOVERY_ITEMS_PER_PAGE2 = RDF::URI.new('http://worldcat.org/vocab/discovery/itemsPerPage')
    DISCOVERY_START_INDEX    = RDF::URI.new('http://worldcat.org/searcho/startIndex')
    DISCOVERY_START_INDEX2    = RDF::URI.new('http://worldcat.org/vocab/discovery/startIndex')
